...
FUNCTION r_sedov (E0, d0, t)
    IMPLICIT NONE
    REAL(KIND=b), INTENT(IN) :: E0, d0, t
    REAL(KIND=b) :: r_sedov, E, d, t_n
    
    ! the formula is in pc unit
    E = E0/1.d51
    d = d0/1.d-24
    t_n = t/1.d2
    r_sedov = 2.3*(E/d)**(1./5)*t_n**(2./5)
END FUNCTION r_sedov
